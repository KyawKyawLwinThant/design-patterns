...
public class ChatRoom implements IChatRoom{
    ...
    @Override
    public void setMessageToChannel(int channelNumber, String message) {
        Channel channel=channels.get(channelNumber);
        System.out.println(channel.getChatter1().getName() + " exchanged "
        + message +" with "+ channel.getChatter2().getName());
    }
